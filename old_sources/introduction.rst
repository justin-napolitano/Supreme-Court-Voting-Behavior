...
I will be testing each model by attempting to predict the outcome of the upcoming case Masterpiece Cakeshop v. Colorado Civil Rights Commision :footcite:t:`masterpieceCake` using the framework proposed by proponents of each model.
